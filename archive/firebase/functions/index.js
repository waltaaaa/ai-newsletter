 ...
 *   1. weeklyPipeline  — Monday 5:30 AM ET  (full pipeline, ready by 6 AM)
...
// ── Weekly full pipeline: Monday 5:30 AM Eastern (ready by 6 AM) ─────
exports.weeklyPipeline = onSchedule(
  {
    schedule: "30 5 * * 1",       // cron: Monday 5:30 AM (finishes ~6 AM)
