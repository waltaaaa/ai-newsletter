...
CSV_PATH  = os.path.join(_ROOT, 'config', 'canada_tracker_master_watchlist.csv')
JSON_PATH = os.path.join(_ROOT, 'config', 'watchlist.json')
RSS_PATH  = os.path.join(_ROOT, 'rss_feeds.json')
