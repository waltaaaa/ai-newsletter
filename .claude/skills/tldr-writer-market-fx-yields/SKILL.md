...
```html
<p><span class="lead-sentence">The Canadian dollar weakened 0.3% to
0.7198 CAD/USD (1.3893 USD/CAD) on the week</span> — the move
reflected the 125-basis-point spread between the Federal Reserve's
3.50-3.75% target and the Bank of Canada's 2.25%
policy rate<sup>1</sup>. Month-over-month, the loonie is down 1.85%;
year-over-year it has depreciated 4.2% against the US dollar<sup>2</sup>.
The euro traded at 1.1460 EUR/USD, up 0.4% on the
week<sup>3</sup>. The database tracks $42.8 billion in trade-exposed
...
week ending March 28, with the 2-10 year spread widening to 63 basis
points</span> — the 10-year yield rose 12 basis points to
3.58% while the 2-year held at 2.95%<sup>5</sup>.
Across the full curve, the 3-month stood at 2.30%, the 1-year at
2.85%, the 5-year at 3.18%, the 20-year at
3.72%, and the 30-year at 3.94%<sup>5</sup>.
Year-over-year, the entire curve has shifted upward: the 2-year rose from
2.62% and the 10-year from 3.22%, a
33-basis-point and 36-basis-point increase
respectively<sup>6</sup>. The database tracks 1,159 projects ($41.5 billion)
 in proposed or planning stages with rate-sensitive financing
...
0.7215 CAD/USD (1.3860 USD/CAD), largely unchanged on the week</span>
— offsetting commodity flows neutralized the 125-basis-point BoC-Fed
rate differential<sup>1</sup>. The euro held at 1.0840 EUR/USD<sup>2</sup>.
Trade-exposed projects in the database total $42.8 billion<sup>3</sup>.</p>

<p><span class="lead-sentence">The Government of Canada yield curve maintained its
normal shape, with the 2-10 year spread steady at 58 basis points</span>
— the 10-year yield edged up 3 basis points to 3.25%,
matching a 3-basis-point rise in the 2-year to 2.67%<sup>4</sup>.
The full curve: 3-month at 2.20%, 1-year at 2.55%,
5-year at 2.98%, 20-year at 3.48%, and 30-year at
3.65%<sup>4</sup>. Rate-sensitive projects in the database total
$41.5 billion<sup>5</sup>.</p>
```
