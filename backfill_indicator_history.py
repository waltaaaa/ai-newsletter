"""
backfill_indicator_history.py — Backfill 5 years of indicator data to indicator_history table.
...
if __name__ == "__main__":
    ...
    print(f"  TOTAL:   {boc_count + statcan_count + yahoo_count + oea_count + isq_count} observations")
    print(f"{'=' * 60}")
