...
newsletter section schema, and Perplexity hook.
...
OPUS_MODEL   = os.environ.get('OPUS_MODEL',   'claude-opus-4-5-20250929')
...
# ══════════════════════════════════════════════════════════════════════════════
# PERPLEXITY HOOK — DISABLED
# ══════════════════════════════════════════════════════════════════════════════
#
# To enable: set ENABLE_PERPLEXITY=true in .env
# When enabled, runs AFTER Tiers 1-2 and queries Perplexity Sonar Pro
...
PERPLEXITY_ENABLED = os.environ.get('ENABLE_PERPLEXITY', 'false').lower() == 'true'
PERPLEXITY_WRITING = os.environ.get('PERPLEXITY_WRITING', 'false').lower() == 'true'
...
# ══════════════════════════════════════════════════════════════════════════════
#
# python update_dashboard.py                    # Normal weekly run (7-day GDELT lookback)
...
# python update_dashboard.py --seed-projects    # Full project seed from scratch
# python update_dashboard.py --test-queries     # Dry run GDELT queries, report hit counts
# python update_dashboard.py --audit-citations  # Re-verify all source URLs, report dead links
